...
const schools = [
  ...
  description:
    "XCL World Academy是新加坡領先的IB國際學校，涵蓋18個月至18歲學生，學生代表40多個國籍。提供IB PYP、MYP、DP等連續課程，並以小班、雙師制和跨學科創新（AI、機器人、編程課程）著稱，協助學生在學術、領導力、全球素養等面向全面發展。近年IB畢業生成績、升學率及獎學金表現均領先全球。最新校園設施完善，並強調家校社群連結。",
