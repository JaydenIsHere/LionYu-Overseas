import './InternationalEduSystem.css';
import React, { useState, useEffect } from 'react';
import eduSystemImg from '../../images/InternationalSchoolEducationMap.jpg';
// 教育體制圖元件
function InternationalEduSystem() {
  const [showFull, setShowFull] = useState(false);
  const stopPropagation = (e) => e.stopPropagation();

  return (
    <div className="education-system-section">
      <h2 className="education-title">新加坡國際學校教育體制升學規劃圖</h2>
...
export default InternationalEduSystem;